...
const SWATCHES = ['#F2A900', '#FFC13B', '#3B4B9B', '#2E3D8C', '#24262B', '#B23A2A', '#1E8E3E', '#6c6960'];
...
export function TagColorPicker({ value, onChange }: { value: string; onChange: (hex: string) => void }) {
  ...
  return (
    <div className="color-picker">
      ...
      <input className="color-picker__native" type="color" value={HEX_RE.test(value) ? value : '#F2A900'}
